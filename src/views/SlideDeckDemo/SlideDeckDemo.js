    ...
    render(){
        ...
        <div>
            <SlideDeck>
                ...
                <Slide>
                    <p>This is a real long slide. There's a lot of content here, and yet, you can't scroll down to see the rest...
                        This keeps it feeling more like a slide show and less like a webpage.
                    </p>
                    <h1>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, 
                        ...
                        vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?"</h1>
                </Slide>
            </SlideDeck>
        </div>
        )
